...
What was my initial approach before optimizing? Even if wrong/brute-force, note it — this is where the learning happens.
...
Plain-English walkthrough of the solution logic, step by step.

## Pseudocode

```
// Rough logic before coding
```
